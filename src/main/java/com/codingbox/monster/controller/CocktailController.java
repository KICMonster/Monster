...
public class CocktailController {
    ...
    @PostMapping("/save")
    public String saveCocktails() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException, ParseException {
        List<Cocktail> cocktails = cocktailService.fetchAllCocktailsFromApi();
